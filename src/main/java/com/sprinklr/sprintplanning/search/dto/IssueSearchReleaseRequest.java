...
public record IssueSearchReleaseRequest(
    ...
    @Schema(description = "Dev sub-domain analysis issue-type profile key (e.g. story, bug)")
    String issueTypeProfile
) {
  public IssueSearchReleaseRequest(String additionalJql) {
    this(additionalJql, null);
  }
}
